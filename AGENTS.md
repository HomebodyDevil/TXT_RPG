...
- Wait for an explicit answer before proceeding with work that depends on that decision. Silence and preselected UI options are not approval. Unaffected read-only investigation and clearly scoped independent work may continue while awaiting the answer.
