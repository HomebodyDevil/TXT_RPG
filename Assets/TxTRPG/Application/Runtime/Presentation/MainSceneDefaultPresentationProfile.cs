...
#if UNITY_EDITOR
        public void ConfigureForEditor(MainScenePreviewScenario value, StoryTextPanelDemoData story, EnemyDisplayPanelDemoData enemy, float delay)
        { scenario = value; storyData = story; enemyData = enemy; simulatedDelay = Mathf.Max(0f, delay); }
#endif
    }
